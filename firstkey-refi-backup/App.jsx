...
const App = () => {
  ...
  // New state variable 'loanMode' (default 'purchase')
  const [loanMode, setLoanMode] = useState('purchase'); // 'purchase' or 'refinance'

  // New state variables for currentLoanBalance, currentInterestRate, currentYearsRemaining, and cashOutAmount
  const [currentLoanBalance, setCurrentLoanBalance] = useState(200000);
  const [currentInterestRate, setCurrentInterestRate] = useState(6.0);
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-3 md:px-4 py-4 md:py-6">
        {currentView === 'home' && (
          <HomeScreen
            ...
            setCurrentLoanBalance={setCurrentLoanBalance}
            currentInterestRate={currentInterestRate}
            setCurrentInterestRate={setCurrentInterestRate}
            currentYearsRemaining={currentYearsRemaining}
            setCurrentYearsRemaining={setCurrentYearsRemaining}
